...
//----------------------------------------------------------------
void VertexAttribute::specify( gl::VertexAttributeIndex location, Size size, uint32_t stride, uint32_t offset )
{
    //m_is_specified = true;
...
//----------------------------------------------------------------
void VertexAttribute::enable( gl::VertexAttributeIndex location )
{
    ...
    //m_is_enabled = true;
    //enable_vertex_array_attribute( ( underlying_cast( location ) );
}

//----------------------------------------------------------------
void VertexAttribute::disable( gl::VertexAttributeIndex location )
{
...
//----------------------------------------------------------------
void VertexAttribute::set_divisor( gl::VertexAttributeIndex location, const uint32_t divisor )
{
